...
def calculate_demographic_data(print_data=True):
    ...
    highest_earning_country = (df[df['salary'] == '>50K'].groupby('native-country')['native-country'].count() /
                               df.groupby('native-country')['native-country'].count() * 100).idxmax()

    highest_earning_country_percentage = round((df[df['salary'] == '>50K'].groupby('native-country')['native-country'].count() /
                               df.groupby('native-country')['native-country'].count() * 100).max(), 1)
